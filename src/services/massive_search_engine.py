...
from services.websailor_client import WebSailorClient
...
class MassiveSearchEngine:
    ...
    def __init__(self):
        self.websailor = WebSailorClient()  # ALIBABA WebSailor
    ...
    async def execute_massive_search(self, produto: str, publico_alvo: str, session_id: str) -> Dict[str, Any]:
        """
    ...
    async def _search_alibaba_websailor(self, query: str, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            result = await self.websailor.search_comprehensive(
                query=query,
                session_id=session_id,
                max_results=15  # Mais resultados para atingir 300KB
            )
            return {
                'query': query,
